package com.github.drmarjanovic.updates.config

import cats.effect.Blocker
import com.github.drmarjanovic.updates.config.Config.{ ApiConfig, DatabaseConfig, HttpConfig, TracerHost }
...
final case class Config(api: ApiConfig, http: HttpConfig, database: DatabaseConfig, tracer: TracerHost)
...
object Config {
  ...
  final case class ApiConfig(contacts: ContactsServiceConfig, messages: MessagesServiceConfig)
