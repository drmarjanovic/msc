...
import com.github.drmarjanovic.users.config.Config.{ ApplicationSecret, DatabaseConfig, HttpConfig, TracerHost }
...
final case class Config(secret: ApplicationSecret, http: HttpConfig, database: DatabaseConfig, tracer: TracerHost)
